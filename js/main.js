...
var CLUB_PORTAL_CLUBS = [
  {
    ...
    detail: `압도적인 팔 힘과 퍼포먼스를 빠르게 만들어드리는 '락클라이밍'입니다! 바쁜 업무 중에도 효율적으로 운동하고 싶은 분들을 위해 준비했습니다.

저희 동호회는 별도의 장비가 전혀 필요 없습니다. 초크, 초크백, 테이프 등 활동에 필요한 모든 장비를 전폭 지원해 드립니다! 열정만 있다면 누구나 최고의 신체 변화와 성취감을 경험할 수 있습니다. 운동 잘해 보이고 싶은 CP님들, 지금 바로 락클라이밍과 함께 한계를 뛰어넘어 보세요!
